            ...
            <div className="featured--vertical">
                <div className="featured--horizontal">
                    ...
                    <div className="featured--buttons">
                        <a href={`/watch/${item.id}`} className="watch--button">Watch</a>
                        <a href={`/list.add/${item.id}`} className= "mylist--button">+ My List</a>
                    </div>
                    <div className="features--genres"><strong>Genres:</strong> {genres.join(', ')} </div>
                </div>
            </div>
        </section>
    )
